...
m1.add_command(label="Teine",accelerator='T',command=lambda:func(1))
m1.add_command(label="Kolmas",accelerator='K',command=lambda:func(2))
m1.add_command(label="Neljas",accelerator='N',command=lambda:func(3))
m1.add_command(label="Viies",accelerator='V',command=lambda:func(4))
m1.add_separator()
